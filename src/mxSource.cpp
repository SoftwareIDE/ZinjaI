...
//	EVT_MENU (mxID_EDIT_UNMARK_LINES, mxSource::OnEditUnMarkLines)
...
void mxSource::SetColours(bool also_style) {
	...
	if (dark) {
		...
		MarkerDefine(mxSTC_MARK_BAD_BREAKPOINT,wxSTC_MARK_ROUNDRECT, _T("BLACK"), _T("LIGHT GRAY"));
		MarkerDefine(mxSTC_MARK_BREAKPOINT,wxSTC_MARK_ROUNDRECT, _T("BLACK"), _T("RED"));
		...
		MarkerDefine(mxSTC_MARK_BAD_BREAKPOINT,wxSTC_MARK_ROUNDRECT, _T("WHITE"), _T("Z DARK GRAY"));
		MarkerDefine(mxSTC_MARK_BREAKPOINT,wxSTC_MARK_ROUNDRECT, _T("WHITE"), _T("RED"));
		MarkerDefine(mxSTC_MARK_EXECPOINT,wxSTC_MARK_SHORTARROW, _T("BLACK"), _T("GREEN"));
