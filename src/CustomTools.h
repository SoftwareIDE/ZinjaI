...
enum { CT_PRE_NONE=0, CT_PRE_SAVE_ONE, CT_PRE_SAVE_PROJECT, CT_PRE_SAVE_ALL };
enum { CT_POST_NONE=0, CT_POST_RELOAD_ONE, CT_POST_RELOAD_ALL };
enum { CT_OUTPUT_HIDDEN=0, CT_OUTPUT_TERMINAL, CT_OUTPUT_DIALOG };
